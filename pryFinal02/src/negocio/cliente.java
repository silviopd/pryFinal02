  ...
  private String telefono;  
    ...
    public void setTelefono(String telefono) {
     ...
     private void cargarLista() throws Exception {
        ...
        while (resultado.next()) {
            ...
            obj.setCodigo_cliente(resultado.getInt("codigo"));
            obj.setEmail(resultado.getString("email"));
            obj.setNombres(resultado.getString("nombre"));
    ...
    public void cargarCombo(JComboBox objCombo) throws Exception {
        ...
        for (cliente listCom : listaCliente) {
            objCombo.addItem(listCom.getNombres());
        }
    }
...
//
//            sql = "INSERT INTO cliente(codigo_cliente, apellido_paterno, apellido_materno, nombres, nro_documento_identidad, telefono, telefono_fijo, telefono_movil1, telefono_movil2, email, direccion_web, codigo_departamento, codigo_provincia, codigo_distrito) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);";
...
//        transaccion.setAutoCommit(false);
//
//        String sql = "UPDATE cliente SET  apellido_paterno=?, apellido_materno=?, nombres=?, nro_documento_identidad=?, telefono=?, telefono_fijo=?, telefono_movil1=?, telefono_movil2=?, email=?, direccion_web=?, codigo_departamento=?, codigo_provincia=?, codigo_distrito=? WHERE codigo_cliente=?;";
//
